			...
			<div class="contentWrapper" id="BodyWrapDiv">
				...
				<div class="sidebarContent">
					<div class="sidebarContentCol">
						...
						<?php 
						   $form_url = actionURL('document_create','?tab=document&mode='.$mode.'&item_id='.$item_id.'&lot_id='.$lot_id);
						?>
						...
						?>						
							...
							<span class="formRow">
								...
								<span class="formInput">
									<input type="text"  name="general[file_desc]"  autocomplete="off" class="twelve"  required value="<?php echo f_html_escape($json_search_items['general']['file_desc']);?>" />
								</span>
							</span>							
							<span class="formRow">
							</span>
