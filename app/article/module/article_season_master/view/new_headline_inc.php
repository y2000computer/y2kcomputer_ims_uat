			...
			<div class="contentWrapper" id="BodyWrapDiv">
				...
				<div class="sidebarContent">
					<div class="sidebarContentCol">
						<div class="fullWidthContent" style="padding-bottom: 0;">
							...
							<span class="contentRow">
								<span class="menu_group_headers">
									<span>
										Name:<?php echo htmlspecialchars($primary['name']); 
										?>									
									</span>
								</span>
							</span>
						...
						<?php 
						   $form_url = actionURL('headline_create','?tab=headline&mode='.$mode.'&item_id='.$item_id.'&lot_id='.$lot_id);
						?>
						...
						?>						
							...
							<span class="formRow">
								...
								<span class="formInput">
									<input type="text"  name="general[headline]"  autocomplete="off" class="twelve"  required value="<?php echo htmlspecialchars($general['headline']);?>" />
								</span>
							</span>							
							<span class="formRow">
							</span>
