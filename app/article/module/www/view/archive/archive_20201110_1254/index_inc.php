...
<script type="text/javascript">
	$(window).on('load',function(){
		...
		console.log('local storage season_id =' + localStorage.getItem('season_id'));
		
		if(localStorage.getItem('season_id') != '<?php echo $season_id;?>'){
			$('#noteModal').modal('show');
			localStorage.setItem('season_id','<?php echo $season_id;?>')
		}
