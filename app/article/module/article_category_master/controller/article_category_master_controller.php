...
list($allow,$level,$add,$change,$delete) = $checkaccess->checkRight('ARTICLE-MAINT-01-005');
if($allow == 0) require __DIR__.'/../../../../template/sorry_inc.php';

$dmGeneralModel = new article_category_master_model();  //Open database connection
