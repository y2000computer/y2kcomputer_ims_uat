...
require_once __DIR__.'../../function/framework_func.php';
require_once __DIR__.'../../function/date_func.php';
require_once __DIR__.'../../function/sql_func.php';
require_once __DIR__.'../../function/string_func.php';
require_once __DIR__.'../../function/translate_func.php';  //using _t(..) to tranlate different language 
require_once __DIR__.'../../function/image_func.php';
require_once __DIR__.'/photolibrary_autoload_config.php';  
