			...
			<div class="contentWrapper" id="BodyWrapDiv">
				...
				<div class="sidebarContent">
					<div class="sidebarContentCol">
						...
						<?php 
						   $form_url =actionURL('subcategory_update','?tab='.$tab.'&mode='.$mode.'&item_id='.$item_id.'&sub_id='.$sub_id.'&lot_id='.$lot_id);
						?>		
						...
						?>						
							...
							<span class="formRow">
								...
								<input type="text"  name="general[name]"  autocomplete="off" class="six" value="<?php echo htmlspecialchars($general['name']);?>" />
								</span>
							</span>							
							<span class="formRow">
							</span>
