				...
				<div class="sidebarContent" id="SubMenuDiv">
					<div class="sidebarContentCol sidebarContentCol-3 transactions" id="TransactionsDiv">
						<ul>
							...
							<?php
							if(in_array("PHOTO-TRAN-01-001", module_array())){ 
							echo '<li class="menu_group_item"><p>';  
							echo '<a href="/'.IS_PORTAL.'/'.IS_LANG.'/photo_entry/">'.'Photo Entry'.'&nbsp;'.'&raquo;'.'</a>';
							echo '</P></li>';
							}
							?>
					...
					<div class="sidebarContentCol sidebarContentCol-3 maintenance" id="MaintenanceDiv">
						<ul>
							...
							<?php
							if(in_array("PHOTO-MAINT-01-001", module_array())){ 
							echo '<li class="menu_group_item"><p>';  
							echo '<a href="/'.IS_PORTAL.'/'.IS_LANG.'/photo_meta_master/">'.'Meta Tag Master'.'&nbsp;'.'&raquo;'.'</a>';
							echo '</p></li>';
							}
							?>
